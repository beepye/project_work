var $notifcenter =      $('#ResourceCenter'),
    $iconTrigger =      $('#ResourceCenter-trigger'),
    $xTrigger =         $('#ResourceCenter-closeTrigger'),
    $blockTrigger=      $('.notificationBlock-close'),
    blockSelector =     '.ResourceCenter-notificationBlock',
    show =              'is-open',
